...
static const double A2R       = PI / 648000.0;
static const double R2H       = 12.0 / PI;
...
static void planetpv (double epoch[2], int np, double pv[2][3])
{
    // working storage
    int       k;
...
// planetpv.
static void radecdist(double state[2][3], double rdd[3])
{
    // distance
...
static void PrintDoubleArray( double const * const array,
                              const int            size )
{
  int         i;
...
static void PrintDoubleMatrix( double matrix[2][3] )
{
  int         i;
