;*=====================================================================*/
;*    .../prgm/project/bglstone/src/bigloo/bigloo/Integrate/kk.scm     */
;*    -------------------------------------------------------------    */
;*    Author      :  Manuel Serrano                                    */
;*    Creation    :  Tue Mar 14 17:30:55 1995                          */
;*    Last change :  Fri Mar  7 07:34:08 2025 (serrano)                */
...
;*---------------------------------------------------------------------*/
(define (K.2! A A-tail)
   (trace (integrate 2) "K.2!..." #\Newline)
   (let loop ((continue #t))
      (if (not continue)
	  A-tail
	  (let liip ((At       A-tail)
		     (continue #f))
	     (trace (integrate 3) " liip: "
